  ...
  return (
    <div className='communitywrapper' >
                ...
                <div className='text-center flex  items-center  justify-center flex-col'>
                    ...
                    <p className='xl:my-3 font-[NeueRegular] text-sm text-center xl:text-3xl xl:w-[500px] text-[#fff] font-[600]' >Sign a lease and it's your <img src={House} className='inline w-6 xl:w-6'  /> too.</p>
                    <div>
