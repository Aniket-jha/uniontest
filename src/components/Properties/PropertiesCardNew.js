...
const PropertiesCardNew = ({property}) => {
  ...
  <a href={property.link} >
    ...
    <div className='my-0 flex items-center px-3 lg:px-3 py-3 justify-center flex-col text-center' >
            ...
            <div className='my-6' >
            <a href={property.link} > <button className="uppercase flex items-center justify-center gap-3 rounded-lg shadow-md  font-[NeueMedium] ease-in duration-300  text-[14px] md:text-[18px]  hover:shadow-none hover:bg-[#272727] tracking-wider py-[6px] px-[24px] md:py-[8px] md:px-[24px] text-[#FFFEFC] bg-[#D64C27]" >Book Now  </button> </a>
            </div>
        </div>
        </div>
    </div>
