  ...
  return (
    <div>
      ...
      <LeadSquaredTracker /> 
       ...
       <Banner beds="144" apartment="38 Apartments" galleryImages={galleryImages} name="House of Balewadi: Best PG in Balewadi for Male & Female" location="Balewadi, Pune" images={images} />
     <Details subtitle="Where Modern Living Meets Vibrant Community Life" title="Experience Modern Living at Balewadi’s Premier Coliving Space" description="Enjoy a seamless blend of comfort, convenience, and community at Balewadi’s top coliving space. With modern amenities, engaging social events, and a prime location, our coliving spaces in Pune offer the perfect environment for students and professionals. Your ideal lifestyle is just a move away. Join us today!" />
       ...
       <Event />
      <TestimonialTwo />
      <BottomNavConstant name="House of Balewadi"  price="Rs. 18,000" brochure="https://firebasestorage.googleapis.com/v0/b/grc-logistics.appspot.com/o/House%20of%20Balewadi-10jun.pdf?alt=media&token=5d544aff-51f4-49ca-8c18-d56dea201607"  />
        <Footer />
        </div>
        </ThemeProvider>
    </div>
