...
const VarsityProperty = () => {
  ...
  return (
    ...
    <LeadSquaredTracker /> 
     ...
     <Banner beds="221" apartment="45 Apartments" galleryImages={galleryImages} name="Varsity: Best Coliving PG in Santacruz, Mumbai" location="Juhu / Santacruz" images={images} />
