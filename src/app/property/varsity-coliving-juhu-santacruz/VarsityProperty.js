...
const VarsityProperty = () => {
  ...
  return (
   ...
   <Details  subtitle="The Student Social Club" title="At the Junction of Bandra and Juhu, live the Best of Both Worlds." description="Varsity is located in the heart of Mumbai’s most demanding and posh area. Varsity is the perfect solution for students and also for those looking for a co-living space in Mumbai that combines comfort, convenience, and a sense of community. Located in the bustling city of Mumbai, Varsity offers a variety of shared and private spaces that cater to all your needs." />
     <Featured />
     <Rooms rooms={rooms} brochure="https://firebasestorage.googleapis.com/v0/b/union-living.appspot.com/o/files%2FVarsity%20by%20Union%202025%20(1).pdf?alt=media&token=957a7fe2-20ef-4283-9c79-8faa5f8e9385" />
     ...
     <Event />
    <TestimonialTwo />
    <BottomNavConstant name="Varsity"  price="Rs. 45,000" youtube="https://www.youtube.com/watch?v=3euMGmLNcIc&embeds_referring_euri=http%3A%2F%2Flocalhost%3A3000%2F&source_ve_path=MjM4NTE&feature=emb_title" brochure="https://firebasestorage.googleapis.com/v0/b/union-living.appspot.com/o/files%2FVarsity%20by%20Union%202025%20(1).pdf?alt=media&token=957a7fe2-20ef-4283-9c79-8faa5f8e9385"  />
      <Footer />
      </div>
      </ThemeProvider>
  </div>
